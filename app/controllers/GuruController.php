...
class GuruController extends SecureController
{
	...
	function index($fieldname = null, $fieldvalue = null)
	{
		...
		if (!empty($request->search)) {
			...
			$search_condition = "(
				guru.id_guru LIKE ? OR 
				guru.nip LIKE ? OR 
				guru.nama_guru LIKE ? OR 
				guru.telepon LIKE ? OR 
				guru.alamat LIKE ? OR 
				guru.user_id LIKE ?
			)";
			$search_params = array(
	...
	function view($rec_id = null, $value = null)
	{
		...
		if ($value) {
			...
			$db->where("guru.id_guru", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null)
	{
		if ($formdata) {
			...
			$request = $this->request;
			// Fillable fields
			$fields = $this->fields = array("nip", "nama_guru", "telepon", "alamat");
			...
			if ($this->validated()) {
				...
				if ($db->has($tablename)) {
					$this->view->page_error[] = "NIP Sudah Ada! Masukkan NIP Lain";
				} else {
					// Insert guru data without user_id
		...
		$page_title = $this->view->page_title = "Tambah Data Guru";
	...
	function edit($rec_id = null, $formdata = null)
	{
		...
		$tablename = $this->tablename;
		//editable fields
		$fields = $this->fields = array("id_guru", "nip", "nama_guru", "telepon", "alamat");
		if ($formdata) {
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nip' => 'required',
	...
	function delete($rec_id = null)
	{
		...
		$db->where("guru.id_guru", $arr_rec_id, "in");
