                ...
                <div class="container">
                    <div class="row ">
                        ...
                        <div class="col-md-8 comp-grid">
                            <h4 class="record-title">Tambah Data Nilai Siswa</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="bg-light p-3 animated fadeIn page-content">
                            <form id="nilai-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("nilai/add?csrf_token=$csrf_token") ?>" method="post">
                                <div>
                                                    ...
                                                    <select id="ctrl-id_alternatif" name="id_alternatif" required="" class="custom-select select2">
                                                        ...
                                                        if (!empty($id_alternatif_options)) {
                                                            foreach ($id_alternatif_options as $option) {
                                                                ...
                                                                $selected = $this->set_field_selected('id_alternatif', $value, $this->view->formdata['id_alternatif'] ?? "");
                                                        ?>
                                    ...
                                    foreach ($kriteria_options as $kriteria) {
                                                        ...
                                                        <div class="">
                                                            <select required="" id="ctrl-k<?php echo $id_kriteria; ?>" name="nilai[<?php echo $id_kriteria; ?>]" class="custom-select select2">
                                                                ...
                                                                foreach ($variabel_options as $option) {
                                                                    $value = (!empty($option['value']) ? $option['value'] : null);
                                                                    $label = (!empty($option['label']) ? $option['label'] : $value);
                                                                    $selected = $this->set_field_selected('nilai[' . $id_kriteria . ']', $value, $this->view->formdata['nilai'][$id_kriteria] ?? "");
                                                                ?>
                                                                    <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                                        <?php echo $label; ?>
                                                                    </option>
                                        ...
                                        ?>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-k<?php echo $id_kriteria; ?>" value="<?php echo $this->set_field_value('nilai[' . $id_kriteria . ']', $this->view->formdata['nilai'][$id_kriteria] ?? ""); ?>" type="text" placeholder="<?php echo $placeholder; ?>" required name="nilai[<?php echo $id_kriteria; ?>]" class="form-control " />
                                                            <small class="form-text text-muted"><?php echo $help_text; ?></small>
                                                        </div>
                                                    </div>
                                                </div>
