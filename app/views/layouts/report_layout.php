		...
		<table class="table table-sm">
			<tr>
				...
				<th align="left" valign="middle">
					...
					<small class="sub-title">SMAN 1 Mejobo</small>
				</th>
				<th align="right" valign="middle">
					<div class="company-info">
						<div>Telepon: <span class="sub-title">(0291) 440074</span></div>
						<div>Email: <span class="sub-title">smamejobo@yahoo.co.id</span></div>
						<div>Web: <span class="sub-title">sman1mejobokudus.sch.id</span></div>
					</div>
